...
* the Technical Electives for the [ASCS (BAS) degree](https://catalog.upenn.edu/undergraduate/programs/computer-science-bas/) and the [ARIN degree](https://catalog.upenn.edu/undergraduate/programs/artificial-intelligence-bse/) are each a bit different, though everything approved (i.e., yes/unrestricted/restricted) on the CSCI list below *does count* as a Technical Elective for these degrees as well
